...
def newClient(request):
    ...
    BrandFormSet = inlineformset_factory(Client, Brand, form=BrandForm, can_delete=False)
    PayerFormSet = inlineformset_factory(Client, Payer, form=PayerForm, can_delete=False)
