...
class Restaurant(models.Model):
    ...
    sum_payment = models.FloatField(null=True, blank=True, verbose_name=u'Сумма оплаты с НДС')
    sum_payment_min = models.FloatField(null=True, blank=True, verbose_name=u'Грн. за мин.')
